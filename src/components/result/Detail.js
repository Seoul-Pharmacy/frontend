    ...
    return (
        <article id="result-details">
            ...
            <div id="result-details-text-wrapper">
                ...
                <div id="result-details-address">주소 | {pharmacy.si} {pharmacy.gu} {pharmacy.road_name_address}</div>
                <div id="result-details-time">
                    <p>영업시간 | 월요일: {pharmacy.mon_open_time}~{pharmacy.mon_close_time}</p>
                    <p>화요일: {pharmacy.tue_open_time}~{pharmacy.tue_close_time}</p>
                    <p>수요일: {pharmacy.wed_open_time}~{pharmacy.wed_close_time}</p>
